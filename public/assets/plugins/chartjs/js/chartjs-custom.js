$(function () {
    "use strict";
    // chart hunian
    new Chart(document.getElementById("chart-hunian"), {
        type: "doughnut",
        data: {
            ...
            datasets: [
                {
                    ...
                    backgroundColor: ["#0d6efd", "#17a00e", "#ffc107"],
                    data: [51, 3, 12],
                },
            ],
        },
        options: {
            ...
            title: {
                display: true,
                text: "Status kepemilikan hunian",
            },
        },
    });

    // chart hunian
    new Chart(document.getElementById("chart-usulan"), {
        type: "doughnut",
        data: {
            labels: ["SHM", "Hak guna", "Akta jual beli"],
            datasets: [
        ...
        options: {
            ...
            title: {
                display: true,
                text: "Usulan Penerima Bantuan Rutilahu",
            },
        },
    });
