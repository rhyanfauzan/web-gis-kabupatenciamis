...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-style ">
        <li class="breadcrumb-item">
            <h4 class="page-title m-b-0">Edit Prasarana Sarana Utilitas Umum</h4>
        </li>
        <li class="breadcrumb-item">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Prasarana Sarana Utilitas Umum</h4>
                </div>
                <div class="card-body">
...
@section('scripts')
    ...
    @include('backend.prasarana-sarana-umum.sub-form.script', ['action' => route('backend.prasaranaSaranaUmum.update', ['id' => $item->id])])
    <script src="{{ asset('js/backend/prasarana-sarana-umum/edit.js') }}"></script>
    @include('backend.prasarana-sarana-umum.sub-form.script-edit')
