...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-style ">
        <li class="breadcrumb-item">
            <h4 class="page-title m-b-0">Tambah Usulan</h4>
        </li>
        <li class="breadcrumb-item">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    @include('backend.usulan.form', ['action' => route('backend.usulan.insert')])
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.usulan.sub-form.script', ['action' => route('backend.usulan.insert')])
