                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="tab-hunian" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="rencana-tab" data-toggle="tab" href="#rencana" role="tab"
                               aria-controls="rencana" aria-selected="false">Rencana Penanganan</a>
                        </li>
                    </ul>
                    <div class="tab-content tab-bordered" id="tab-hunian-content">
                        <div class="tab-pane fade show active" id="hunian" role="tabpanel" aria-labelledby="hunian-tab">
                            @include('backend.penerima-bantuan.sub-form.detail-hunian')
                        </div>
                        <div class="tab-pane fade" id="keluarga" role="tabpanel" aria-labelledby="keluarga-tab">
                            @include('backend.penerima-bantuan.sub-form.detail-keluarga')
                        </div>
                        <div class="tab-pane fade" id="lokasi" role="tabpanel" aria-labelledby="lokasi-tab">
                            @include('backend.penerima-bantuan.sub-form.detail-lokasi')
                        </div>
                        <div class="tab-pane fade" id="rencana" role="tabpanel" aria-labelledby="rencana-tab">
                            @include('backend.penerima-bantuan.sub-form.detail-rencana')
                        </div>
                    </div>
                </div>
            </div>
